...
TRACK_KEYS = {
    ...
    "detect_bpm": ("detect BPM", "b"),
    "link": ("link: goes well with…", "w"),
    "show_linked": ("show the linked tracks", "W"),
    # "p" is paste_tags, so the playlist keys take the shifted pair.
    "add_to_playlist": ("add to a playlist…", "P"),
    "show_playlists": ("show a playlist this track is in", "S"),
    "favorite": ("favorite", "f"),
...
MENU_KEYS = {
    ...
    "m_add_playlist": ("add to a playlist", "Ctrl+P"),
    "m_show_playlist": ("show a playlist this track is in", "Ctrl+Shift+P"),
    "m_playlists": ("all playlists", "Ctrl+Alt+P"),
